...
val print_info : ppf:Format.formatter -> ('a, Format.formatter, unit, unit) format4 -> 'a

(** Print a message *)
val print_message :
  ppf:Format.formatter -> ?loc:location -> string ->
  ('a, Format.formatter, unit, unit) format4 -> 'a

(** Print an error message *)
val print_error :
  ppf:Format.formatter -> location * string * string -> unit
